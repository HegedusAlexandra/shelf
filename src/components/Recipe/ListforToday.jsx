    ...
    <div className="flex flex-col w-[100%] gap-2">
      ...
      >
        <button
          ...
          className="xl:w-[1.5vw] z-20 md:w-[4vw] w-[6vw] py-[10px] font-bold flex items-center justify-center bg-yellow-300 xl:rounded-l-md rounded-r-md xl:rounded-r-none rounded-l-none font-playwrite px-auto hover:bg-yellow-400"
        >
          <div
        ...
        <div
          className={`w-[86%] my-4 bg-stone-50 text-black/60 text-sm uppercase teal-50 flex flex-col justify-start items-center xl:rounded-l-lg xl:rounded-r-none rounded-r-lg rounded-l-none py-[2vh] pr-[0vh]`}
          style={{
        ...
        >
          <button
            ...
            onClick={() => {
              ...
              setListOfCakeId(todays?.getRecipesForToday);
            }}
