  ...
  return (
    <div className="relative h-[100%] bg-black">
      ...
      <button
        ...
        className={`absolute top-4 left-4 z-50 text-lime-200 rounded-full hover:bg-gray-700 transition-all ${isVisible ? "translate-x-[28vw]" : "translate-x-0"}`}
      >
        {isVisible ?  <button
              className="w-[30px] rotate-45 h-full flex justify-center items-center ring-[1px] ring-gray-500 rounded-full hover:bg-white/50"
              
            >
              <img src={plus} alt="plus" />
            </button> :
            <button
              className="w-[31px] h-full flex justify-center items-center rounded-full text-black hover:bg-white/50"
